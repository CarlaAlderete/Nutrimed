...
const doctorActions = {
   getDoctors: () => {
      return async (dispatch, getState) => {
         try {
            let res = await axios.get("https://nutrimed.herokuapp.com/api/doctors")
   ...
   getOneDoctorDB: (id) => {
      return async (dispatch, getState) => {
         try {
            let res = await axios.get(`https://nutrimed.herokuapp.com/api/doctor/${id}`)
            if (res.data.success) {
      ...
      return async () => {
         try {
            let res = await axios.put(
               `https://nutrimed.herokuapp.com/api/doctor/${id}`,
      ...
      return async () => {
         try {
            let res = await axios.get(
               "https://nutrimed.herokuapp.com/api/appointments/",
               {
                  headers: {
      ...
      return async () => {
         try {
            let res = await axios.delete(
               `https://nutrimed.herokuapp.com/api/appointment/${id}`,
               {
                  headers: {
                     Authorization: "Bearer " + token,
                  },
   ...
   getAppointementByDoctor: (dorctorid) => {
      return async () => {
         try {
            let res = await axios.get(
               `https://nutrimed.herokuapp.com/api/appointment/${dorctorid}`
            )
            if(res.data.success){
               return { success: true, res: res.data.res }
            }else{
   ...
   sendScore: (data) => {
      ...
      return async () => {
         try {
            let res = await axios.put(
               `https://nutrimed.herokuapp.com/api/doctor/${doc}`,
               { point, action },
               {
                  headers: {
                     Authorization: "Bearer " + user,
   ...
   deleteProfileDoctor: (token) => {
      return async () => {
         try {
            let res = await axios.delete("https://nutrimed.herokuapp.com/api/doctor", {
               headers: {
                  Authorization: "Bearer " + token,
               },
            })
